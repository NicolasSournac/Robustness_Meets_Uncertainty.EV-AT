...
from ev_at.modules import BaseModule

__all__ = ["IKLTrainingModule"]


class IKLTrainingModule(TrainingModule):
    """IKL Adversarial training module.
    Code extracted from:
    https://github.com/jiequancui/DKL/blob/main/DKLv2/
    """
