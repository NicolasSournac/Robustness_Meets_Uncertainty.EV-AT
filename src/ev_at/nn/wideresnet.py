# This code is extracted from https://github.com/jiequancui/DKL/blob/main/DKLv2/Adv-training-dkl/models/wideresnet.py
import math
...
class WideResNet(nn.Module):
    def __init__(
        ...
        if normalized_cls:
            self.fc = NormedLinear_Classifier(
                num_classes, nChannels[3], scale=normalized_cls
            )
        else:
